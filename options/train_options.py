...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--train_G_every_n_iterations', type=int, default=10, help='train G every n interations')
        self._parser.add_argument('--poses_g_sigma', type=float, default=0.06, help='initial learning rate for adam')
        self._parser.add_argument('--lr_G', type=float, default=0.0005, help='initial learning rate for G adam')
        ...
        self._parser.add_argument('--lr_D', type=float, default=0.00005, help='initial learning rate for D adam')
        ...
        self._parser.add_argument('--lambda_D_cond', type=float, default=1000, help='lambda for condition discriminator loss')
